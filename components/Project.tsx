...
function Project({ title, description, tags, imageUrl }: ProjectProps) {
  ...
  return (
    ...
    >
      <section className=" bg-gray-100 hover:bg-gray-200 transition max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 group-even:pl-8">
